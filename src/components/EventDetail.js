...
const eventDetailsArray = [
  {
    ...
    teamRequirements: "There are no specific requirements for the team or the team members.",
    format: "There are no specific requirements for the team or the team members.",
    judgingCriteria: `
              ...
              <div className="col-md-10 frame-content mt-5">
                  ...
                  <div className="details">
                    <ul>
                      {/* {event.details.map((detail, detailIndex) => (
                       ...
                       <br />
                       <BsFillCalendarCheckFill class="event-icon"/> {event.details[1]}
                      <br />
                ...
                <div className="rules scrollable-rules">
                  <div className="description">
                    <div className="close-flex">
                      <h2>DESCRIPTION</h2>
                      <img src={Icon_close} alt="nothing" />
                    </div>
                    ...
                    <h2>REGISTRATION DETAILS</h2>
                    <ul>
                      {event.registrationDetails.map((regDetail, regDetailIndex) => (
