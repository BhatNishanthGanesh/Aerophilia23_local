...
export const eventData = [
  {
    ...
    judgingCriteria: [
      "The team with the maximum average score from both the rounds will be declared the winner. i.e, after adding the score from the first round and the second round whichever team has higher score that team will be declared the winner.",
    ],
    contactDetails: [
      {
        name: "Babith",
